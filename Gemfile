...
gem "logstash-filter-ruby", :github => "logstash-plugins/logstash-filter-ruby", :branch => "feature/plugin-api-2_0"
gem "logstash-codec-plain", :github => "logstash-plugins/logstash-codec-plain", :branch => "feature/plugin-api-2_0"
gem "logstash-filter-kv", :github => "logstash-plugins/logstash-filter-kv", :branch => "feature/plugin-api-2_0"
gem "logstash-filter-date", :github => "logstash-plugins/logstash-filter-date", :branch => "feature/plugin-api-2_0"
